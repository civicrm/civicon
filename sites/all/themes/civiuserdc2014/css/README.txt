...
To use these stylesheets, rename the files and civiconcrete with the name of your theme.
...
civiconcrete-alpha-default.css
...
civiconcrete-alpha-default-narrow.css  
...
civiconcrete-alpha-default-normal.css
...
civiconcrete-alpha-default-wide.css
